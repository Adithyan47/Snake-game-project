...
class MAIN:
    ...
    def draw_level(self):
        ...
        pygame.draw.rect(screen, (167, 209, 61), level_rect)
    ...
    def add_obstacles(self):
        for _ in range(self.level):
            while True:
                obstacle = Vector2(random.randint(0, cell_number - 1), random.randint(0, cell_number - 1))
                if obstacle not in self.snake.body and obstacle != self.fruit.pos:
